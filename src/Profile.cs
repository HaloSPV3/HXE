  ...
  public class Profile : File
  {
    ...
    public void Save()
    {
      ...
      byte[] GetHash()
      {
        ...
        /**
         * We read all of the data into memory from the blam.sav binary. However, we proceed to chop off the last 4
         * bytes, because they are used for the storing the hash itself:
         *
         ...
         * flip each bit in the entire hash. Once we've done that, we are left with the desired hash that can be stored
